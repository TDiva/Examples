...
public class FindByGenrePanel extends JPanel {

	private static final long serialVersionUID = 7879406418533432286L;
	...
	public FindByGenrePanel() {
		...
		JLabel lbl = new JLabel("Введите жанр:");
		lbl.setPreferredSize(new Dimension(100, 20));
		topPanel.add(lbl);
		var = new JTextArea();
		var.setPreferredSize(new Dimension(150, 20));
		topPanel.add(var);
		JButton btn = new JButton("Искать");
		btn.addActionListener(new ActionListener() {

			@Override
			public void actionPerformed(ActionEvent arg0) {
				String genre = var.getText();
				foundFilms = repo.findByGenre(genre);
